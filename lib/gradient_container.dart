...
// StatelessWidget je flutter class-a
class GradientContainer extends StatelessWidget {
// class GradientContainer extends StatefullWidget {
  //? constructor fn
  // const GradientContainer({key}) : super(key: key);
  // const GradientContainer({super.key});// position argument
  const GradientContainer(this.color1, this.color2, {super.key});
  //! positional argument su uvek required
...
/* 
  ...
  void rollDice() {
    /*  image se ne menja bez obz sto se ovaj kod okida (vidimo print u konzoli) jer ga koristimo unutar StatelessWidget-a. I koristeci StatelessWidget je jedan od 2 glavna nacina za pravljenje widgeta. I za ovakle stvari treba da koristimo StateFULLWidget.
    
    //? StatefullWidget
    - nam omogucava da menadzujemo state unutar nje. State su podaci koji se vremenom mogu promeniti i uticu na renderovani UI, takoreci, ako se podaci promene, UI ce se promeniti.
    ! - MEDJUTIM! Ovde ce se samo menjati activeDiceImage tj ono sto depends on it, takoreci samo slika, ostale stvari su prilicno stabilne. tako da bi zapravo bilo bolje da ipak klasa bude StateLESSWidget, tacnije da ovaaj nas widget podelimo na dva Widgeta, jedan StatelessWidget, i jedan StatefullWidget za ovaj deo gde se nalaze slika i dugme.
    Zato cemo dodati novi file, dice_roller.dart */
